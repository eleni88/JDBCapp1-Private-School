...
public class JDBCapp1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        System.out.println("If you want to print a list of Students press 7.");
        System.out.println("If you want to print a list of Assignments press 8.");
        System.out.println("If you want to print a list of Trainers press 9.");
        System.out.println("If you want to print a list of Courses press 10.");
